...
const images = {
  ...
  dietitiannutritionist: "/assets/images/24_7services/dietitiannutritionist/dietitiannutritionist.jpeg",
...
const wardServices = [
  ...
  createService(
    ...
    "Wards",
    images.about,
    "Affordable general ward care for male patients with round-the-clock nursing.",
    ["Multi-bed Ward", "Male Patient Care", "Nursing Support", "Essential Facilities"],
    ["Cost-effective inpatient care", "Safe monitored environment", "24x7 ward staff"],
  ),
  createService(
    "female-general-ward",
    "Female General Ward",
    ...
    "Wards",
    images.care,
    "Dedicated general ward care for female patients in a safe environment.",
    ["Female-only Ward", "Privacy-focused Care", "Nursing Support", "Safe Environment"],
    ["Dedicated female ward area", "Compassionate nursing teams", "Affordable hospital stay"],
  ),
];
