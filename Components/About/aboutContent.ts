...
export const chairpersonMessage = {
  ...
  title: "Chairperson, Sangi Hospital",
  image: "/assets/images/about/chairperson.jpg",
  paragraphs: [
    "Welcome to the Sangi Hospital. The healthcare provided at Sangi Hospital and Health Services is all about people, namely you our valued customers. We appreciate the steadfast support of our hospital as we continue to provide the most up to date and compassionate care.",
    "We always keep this in mind, as we strive to expand by increasing the number of departments and medical services and to ensure the provision of the latest treatments for patients, and the use of the latest medical devices and equipment. Under the supervision of qualified and specialized medical and administrative staff, they all work around the clock to provide excellent health care that puts the safety and comfort of the patient at the forefront of the hospital's responsibilities.",
    "We look forward to embracing new changes as we shape tomorrow and grow our services to keep your care local. I welcome you to explore our website and health information anytime you need additional information regarding you or your loved one's health.",
  ],
  closingNote: "I pray and wish for everyone to be blessed with good health.",
};
