...
const imageBySpecialityId: Record<string, string> = {
  "general-medicine": specialityImages.clinical,
  "general-surgery": specialityImages.facility,
  orthopaedics: specialityImages.clinical,
  "obstetrics-gynaecology": specialityImages.care,
  paediatrics: specialityImages.care,
  neurology: specialityImages.clinical,
  ent: specialityImages.facility,
  dermatology: specialityImages.care,
  gastroenterology: specialityImages.diagnostics,
  nephrology: specialityImages.clinical,
  urology: specialityImages.facility,
  dentistry: specialityImages.care,
  diabetology: specialityImages.diagnostics,
  physiotherapy: specialityImages.clinical,
  radiology: specialityImages.diagnostics,
  pathology: specialityImages.diagnostics,
  haematology: specialityImages.diagnostics,
  "emergency-trauma-care": specialityImages.emergency,
};
